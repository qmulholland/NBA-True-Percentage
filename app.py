...
# --- HIGH PERFORMANCE WIN SIMULATION ---
...
if conn:
    ...
    # 1. UPDATED SELECTBOX: index=None ensures it starts blank
    ...
    # 2. MAIN SCREEN LOGIC: Only show if a player is selected
    if selected_player:
        ...
        # Initial Welcome Message when no player is selected
